    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle!=null){
            ...
            if(question!=null){
                ...
                ansA.setText(question.getAns1().getContentAns());
                ansB.setText(question.getAns2().getContentAns());
                ansC.setText(question.getAns3().getContentAns());
                ansD.setText(question.getAns4().getContentAns());
            }
        }
        return view;
    }
